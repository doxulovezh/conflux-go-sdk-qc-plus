...
type AccountManagerOperator interface {
	...
	Unlock(address types.Address, passphrase string, codestr string) error
	UnlockDefault(passphrase string, codestr string) error
	TimedUnlock(address types.Address, passphrase string, timeout time.Duration, codestr string) error
	TimedUnlockDefault(passphrase string, timeout time.Duration, codestr string) error
